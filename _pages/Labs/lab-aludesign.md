...
**Note**: This is the original combined ALU design lab, which has since been split into the [Adder Design](../Labs/AdderDesign) and [1 Bit ALU](../Labs/ALU1Bit) labs.  It is provided here as an end-to-end practice exercise: if you can work through this page from a blank directory without referring back to your prior submissions, you have mastered the VHDL design workflow for the ALU.  It also makes a good review before designing the [4 Bit ALU](../Labs/ALU4Bit).
