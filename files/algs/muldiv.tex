...
\begin{algorithm}[hbt!]
\caption{An Improved Binary Integer Division Algorithm Using a 32-bit ALU, Using the Right Half of the Remainder as the Dividend, and Placing the Remainder in the Left Half of the Reminader Register, and the Quotient in the Right Half of the Remainder Register}\label{alg:div1}
\begin{algorithmic}

\State $remainder_{31:0} \gets dividend$
