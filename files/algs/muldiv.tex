...
\For{$i = 0$; $i < 32$; $i{+}{+}$}
    \If{$multiplier_{0}$ == 1}
        \State $product_{31:16} \gets product_{31:16} + multiplicand$    
    \EndIf
...
\State $product{15:0} \gets multiplier$
...
\State $remainder_{31:16} \gets dividend$
\State $remainder \gets remainder << 1$

\For{$i = 0$; $i < 32$; $i{+}{+}$}
    \State $remainder_{31:16} \gets remainder_{31:16} - divisor$
    ...
    \State $remainder_{31:16} \gets remainder_{31:16} >> 1$
\EndFor
